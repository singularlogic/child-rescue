    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='demographic_data', to='cases.Case')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_grades', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='choices.SchoolGrades')),
            ],
            options={
