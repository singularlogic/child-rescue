    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('health_issues', models.CharField(blank=True, choices=[('pathological', 'Pathological'), ('diabetes', 'Diabetes'), ('heart_issues', 'Heart Issues'), ('other', 'Other')], max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hair_color', models.CharField(blank=True, choices=[('black', 'Black'), ('brown', 'Brown'), ('red', 'Red'), ('blond', 'Blond'), ('other', 'other')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_grades', models.CharField(blank=True, choices=[('excellent', 'Excellent'), ('good', 'Good'), ('average', 'Sufficient'), ('not_good', 'Not good'), ('bad', 'Bad')], max_length=50, null=True)),
                ('school_absences', models.CharField(blank=True, choices=[('low', 'Low'), ('medium', 'Medium'), ('high', 'High'), ('none', 'None'), ('unknown', 'Unknown')], max_length=50, null=True)),
